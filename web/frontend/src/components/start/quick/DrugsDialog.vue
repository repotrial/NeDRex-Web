  ...
  <v-dialog width="500px" v-model="model" style="z-index: 1001; max-height: 80vh">
    <v-card>
      ...
      <div style="width: 100%; display: flex; justify-content: center; padding: 8px;">
        <v-data-table style="max-height: 80vh; overflow-y: auto" :items="drugs" :headers="[{title:'Name', align:'start', sortable:true, value:'displayName'},{title:'SourceID', value:'primaryDomainId', sortable: false, align: 'start'}]">
