                  ...
                  <template v-slot:footer>
                    <div style="display: flex; justify-content: center; margin-left: auto">
                      <div style="padding-top: 16px">
                        <ResultDownload v-show="seeds !=null && seeds.length>0 && results.targets !=null" raw results seeds
                                        @downloadEvent="downloadSeedList" @downloadResultsEvent="downloadModuleResultList"
