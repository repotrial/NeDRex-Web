    ...
    >
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="4">
          <Validation ref="validation" :step="4" :seed-type-id="seedTypeId" :module="results.targets" @drugCountUpdate="updateDrugCount" @printNotificationEvent="printNotification"></Validation>
