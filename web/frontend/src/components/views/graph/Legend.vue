        ...
        <v-list-item-avatar min-width="65" height="20">
            ...
            <v-icon class="edge-icon" :color="getColoring('edges',edge.name,'light')[0]">fas fa-genderless</v-icon>
              <template v-if="direction(edge.name)===0">
                <v-icon class="edge-icon" left small>fas fa-undo-alt</v-icon>
              </template>
              <template v-else>
                <v-icon class="edge-icon" small v-if="direction(edge.name)===1">fas fa-long-arrow-alt-right</v-icon>
                <v-icon class="edge-icon" small v-else>fas fa-arrows-alt-h</v-icon>
