...
/**
 * Entity class for the RepoTrial edge "ProteinEncodedBy" (protein_encoded_by in db).
 * The attributes primaryDomainIds of {@link ProteinEncodedBy#sourceDomainId} and {@link ProteinEncodedBy#targetDomainId} contain the ids of the {@link de.exbio.reposcapeweb.db.entities.nodes.Protein} (source) and the origin {@link de.exbio.reposcapeweb.db.entities.nodes.Gene} (target).
